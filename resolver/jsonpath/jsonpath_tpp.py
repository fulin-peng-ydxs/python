...
url = ('https://dianying.taobao.com/cityAction.json?activityId&_ksTS=1629789477003_137&jsoncallback=jsonp138&action'
...
with open('json/jsonpath_tpp.json', 'w', encoding='utf-8') as fp:
    fp.write(content)

obj = json.load(open('json/jsonpath_tpp.json', 'r', encoding='utf-8'))
